...
def render_svg(bracket, subtitle="Promiedos API tablas"):
    W, H = 1800, 1010
    bw, bh = 230, 86
...
<text x="900" y="230" class="trophy">🏆</text>''']
    ...
    parts.append(f'''<text x="900" y="958" class="foot">{escape(source)}</text><text x="900" y="980" class="foot">Pantalla horizontal · zoom móvil · Promiedos API tablas</text><style>
